...
# ================== ABOUT US ==================
    ...
    with a1:
        ...
        except: st.image("https://via.placeholder.com/300/ffc2e6/000?text=Alya Mukhbita", width="stretch")
    with a2:
        st.markdown("<div style='padding-left:2rem;'><h3>Alya Mukhbita</h3><p><strong>NIM:</strong> 004202400003<br><strong>Role:</strong> Project Leader</p><p style='color:#6bb6ff; font-style:italic;'>Leading with grace</p></div>", unsafe_allow_html=True)
    ...
    with t1:
        ...
        except: st.image("https://via.placeholder.com/300/f9e2ff/000?text=Talytha Belva Clarisa", width="stretch")
    with t2:
        st.markdown("<div style='padding-left:2rem;'><h3>Talytha Belva Clarisa</h3><p><strong>NIM:</strong> 004202400020<br><strong>Role:</strong> Main Developer</p><p style='color:#6bb6ff; font-style:italic;'>Code is poetry</p></div>", unsafe_allow_html=True)
